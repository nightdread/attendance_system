...
- [ ] **Более детальная отчетность** - расширенные отчеты по периодам, сравнение периодов, статистика по отделам (базовая аналитика есть)
- [ ] **Экспорт данных в Excel** - экспорт событий и отчетов в Excel формат с форматированием и графиками
